...
export const sendResultsMail = async (email: string, dataResults: DataResults): Promise<void> => {
  ...
  const mailOptions = {
    ...
    * {
    ...
    <tr>
    <td class="pad">
    <div class="alignment" align="center"><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${process.env.FRONT_END_URL}/session/${sessionId}/results/${mailCrypt}" style="height:42px;width:580px;v-text-anchor:middle;" arcsize="120%" stroke="false" fillcolor="#199bf6"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, Verdana, sans-serif; font-size:16px"><![endif]--><a href="${
